...
# Install hdf5r
RUN R --no-echo --no-restore --no-save -e "install.packages('hdf5r', 'dplyr')"
...
#docker build --no-cache -t interactive_Palantir:1.0 --file Palantir.Dockerfile . --progress=plain
#docker save -o interactive_Palantir.tar interactive_Palantir:1.0

#docker run -it -v /scratch/CD34cells_Palantir/:/docHome/scratch/ -v interactive_Palantir:1.0